function getPhase(board) {
  ...
  for (var i = 0; i <= 2; i++) {
    if (arr[i][0] == arr[i][1] && arr[i][0] == arr[i][2] && a[i][0]!='-') return arr[i][0] + '_win';
  }
  ...
  for (var i = 0; i <= 2; i++) {
    if (arr[0][i] == arr[1][i] && arr[0][i] == arr[2][i] && a[0][i]!='-') return arr[0][i] + '_win';
  }
  ...
  if (arr[0][0] == arr[1][1] && arr[0][0] == arr[2][2]) return arr[0][0] + '_win';
  if (arr[0][2] == arr[1][1] && arr[0][2] == arr[2][0]) return arr[0][2] + '_win';
